defmodule Scada.MixProject do
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind scada", "esbuild scada"],
      "assets.deploy": [
        "tailwind scada --minify",
        "esbuild scada --minify",
        "phx.digest"
      ],
      "release.clean": ["run delete_release", "release"],
      deploy: ["setup", "assets.deploy", "release.clean"]
    ]
  end
