    ...
    [
      ...
      %{
        ...
        items: [
          ...
          {"Frequency of supply voltages", "GVL_Visu.stVisu_MeterAC_NR30IoT_read.Fgrid", "kWh",
           "N/A"},
          {"Total system power factor", "GVL_Visu.stVisu_MeterAC_NR30IoT_read.Pfactor", "",
           "N/A"},
          ...
          {"Phase 1 line to neutral volts", "GVL_Visu.stVisu_MeterAC_NR30IoT_read.U1Nrms", "V",
           "N/A"},
          {"Phase 2 line to neutral volts", "GVL_Visu.stVisu_MeterAC_NR30IoT_read.U2Nrms", "V",
           "N/A"},
          {"Phase 3 line to neutral volts", "GVL_Visu.stVisu_MeterAC_NR30IoT_read.U3Nrms", "V",
           "N/A"},
          ...
          {"Connections [true/false]", "GVL_Visu.stVisu_MeterAC_NR30IoT_read.Connection", "",
           "N/A"},

          # Set
          {"Switch meter on/off [true/false]", "GVL_Visu.stVisu_MeterAC_NR30IoT_set.bONOFF",
           "bool", "N/A"},
          {"Reset daily energy [true/false]",
           "GVL_Visu.stVisu_MeterAC_NR30IoT_set.bResetDailyEnergy", "bool", "N/A"},
          ...
          {"Frequency of supply voltages", "GVL_Visu.stVisu_stMeterAC_NMID30_read.Fgrid", "kWh",
           "N/A"},
          {"Total system power factor", "GVL_Visu.stVisu_stMeterAC_NMID30_read.Pfactor", "",
           "N/A"},
          ...
          {"Phase 1 line to neutral volts", "GVL_Visu.stVisu_stMeterAC_NMID30_read.U1Nrms", "V",
           "N/A"},
          {"Phase 2 line to neutral volts", "GVL_Visu.stVisu_stMeterAC_NMID30_read.U2Nrms", "V",
           "N/A"},
          {"Phase 3 line to neutral volts", "GVL_Visu.stVisu_stMeterAC_NMID30_read.U3Nrms", "V",
           "N/A"},
          ...
          {"Connections [true/false]", "GVL_Visu.stVisu_stMeterAC_NMID30_read.Connection", "",
           "N/A"},

          # Set
          {"Switch meter on/off [true/false]", "GVL_Visu.stVisu_stMeterAC_NMID30_set.bONOFF",
           "bool", "N/A"},
          {"Reset daily energy [true/false]",
           "GVL_Visu.stVisu_stMeterAC_NMID30_set.bResetDailyEnergy", "bool", "N/A"}
        ]
      },
      %{
        title: "PV",
      ...
      %{
        ...
        items: [
          # Read
          {"Power Breaker Status on Inverter AFE Side", "GVL_Visu.stVisu_RGx_read.NSX250B_AFE",
           "", "N/A"},
          {"Power Breaker Status on Converter PV Side", "GVL_Visu.stVisu_RGx_read.NSX250B_PV", "",
           "N/A"},
          {"Power Breaker Status on Converter LIION Side",
           "GVL_Visu.stVisu_RGx_read.NSX250B_LIION", "", "N/A"},
          {"Circuit Breaker Status on the KontrolaDostepu",
           "GVL_Visu.stVisu_RGx_read.KontrolaDostepu", "", "N/A"},
          {"Circuit Breaker Status on the ObwodGniad1f", "GVL_Visu.stVisu_RGx_read.ObwodGniad1f",
           "", "N/A"},
          {"Circuit Breaker Status on the Wentylator1", "GVL_Visu.stVisu_RGx_read.Wentylator1",
           "", "N/A"},
          {"Circuit Breaker Status on the Wentylator2", "GVL_Visu.stVisu_RGx_read.Wentylator2",
           "", "N/A"},
          {"Circuit Breaker Status on the Wentylator3", "GVL_Visu.stVisu_RGx_read.Wentylator3",
           "", "N/A"},
          {"Circuit Breaker Status on the Wentylator4", "GVL_Visu.stVisu_RGx_read.Wentylator4",
           "", "N/A"},
          {"Circuit Breaker Status on the Klimatyzacja", "GVL_Visu.stVisu_RGx_read.Klimatyzacja",
           "", "N/A"},
          {"Circuit Breaker Status on the Rezerwa1_AC", "GVL_Visu.stVisu_RGx_read.Rezerwa1_AC",
           "", "N/A"},
          {"Circuit Breaker Status on the Rezerwa2_AC", "GVL_Visu.stVisu_RGx_read.Rezerwa2_AC",
           "", "N/A"},
          ...
          # Set
          {"Change Circuit Breaker Switch Status on the KontrolaDostepu",
           "GVL_Visu.stVisu_RGx_set.KontrolaDostepu", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the ObwodGniad1f",
           "GVL_Visu.stVisu_RGx_set.ObwodGniad1f", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Wentylator1",
           "GVL_Visu.stVisu_RGx_set.Wentylator1", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Wentylator2",
           "GVL_Visu.stVisu_RGx_set.Wentylator2", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Wentylator3",
           "GVL_Visu.stVisu_RGx_set.Wentylator3", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Wentylator4",
           "GVL_Visu.stVisu_RGx_set.Wentylator4", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Klimatyzacja",
           "GVL_Visu.stVisu_RGx_set.Klimatyzacja", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Rezerwa1_AC",
           "GVL_Visu.stVisu_RGx_set.Rezerwa1_AC", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Rezerwa2_AC",
           "GVL_Visu.stVisu_RGx_set.Rezerwa2_AC", "bool", "N/A"},
      ...
      %{
        ...
        items: [
          # Read
          {"Power Breaker Status on Converter EV Side", "GVL_Visu.stVisu_RGx_read.NSX250B_EV", "",
           "N/A"},
          {"Power Breaker Status on Converter SCAP Side", "GVL_Visu.stVisu_RGx_read.NSX250B_SCAP",
           "", "N/A"},
          {"Power Breaker Status on Converter AGM Side", "GVL_Visu.stVisu_RGx_read.NSX250B_AGM",
           "", "N/A"},
          {"Power Breaker Status on Converter LOAD Side", "GVL_Visu.stVisu_RGx_read.NSX250B_LOAD",
           "", "N/A"},
          {"Circuit Breaker Status on the Rezerwa2_AC", "GVL_Visu.stVisu_RGx_read.ZasilaczeBMS1",
           "", "N/A"},
          {"Circuit Breaker Status on the Rezerwa2_AC", "GVL_Visu.stVisu_RGx_read.ZasilaczeBMS2",
           "", "N/A"},
          {"Circuit Breaker Status on the ZasilaczeBMS3",
           "GVL_Visu.stVisu_RGx_read.ZasilaczeBMS3", "", "N/A"},
          {"Circuit Breaker Status on the ZasilaczeBMS4",
           "GVL_Visu.stVisu_RGx_read.ZasilaczeBMS4", "", "N/A"},
          {"Circuit Breaker Status on the Oswietlenie", "GVL_Visu.stVisu_RGx_read.Oswietlenie",
           "", "N/A"},
          {"Circuit Breaker Status on the Rezerwa24V_1", "GVL_Visu.stVisu_RGx_read.Rezerwa24V_1",
           "", "N/A"},
          {"Circuit Breaker Status on the Rezerwa24V_2", "GVL_Visu.stVisu_RGx_read.Rezerwa24V_2",
           "", "N/A"},
          {"Circuit Breaker Status on the Rezerwa24V_3", "GVL_Visu.stVisu_RGx_read.Rezerwa24V_3",
           "", "N/A"},
          {"Circuit Breaker Status on the RezerwaDC", "GVL_Visu.stVisu_RGx_read.RezerwaDC", "",
           "N/A"},
          {"Circuit Breaker Status on the Supply_AGM_24V",
           "GVL_Visu.stVisu_RGx_read.Supply_AGM_24V", "", "N/A"},
          {"Circuit Breaker Status on the Supply_LIION_24V",
           "GVL_Visu.stVisu_RGx_read.Supply_LIION_24V", "", "N/A"},
          {"Circuit Breaker Status on the Supply_BUS_24V",
           "GVL_Visu.stVisu_RGx_read.Supply_BUS_24V", "", "N/A"},
          {"Circuit Breaker Status on the Zasilanie760V_24V",
           "GVL_Visu.stVisu_RGx_read.Zasilanie760V_24V", "", "N/A"},
          ...
          # Set
          {"Change Circuit Breaker Switch Status on the Rezerwa2_AC",
           "GVL_Visu.stVisu_RGx_set.ZasilaczeBMS1", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Rezerwa2_AC",
           "GVL_Visu.stVisu_RGx_set.ZasilaczeBMS2", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the ZasilaczeBMS3",
           "GVL_Visu.stVisu_RGx_set.ZasilaczeBMS3", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the ZasilaczeBMS4",
           "GVL_Visu.stVisu_RGx_set.ZasilaczeBMS4", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Oswietlenie",
           "GVL_Visu.stVisu_RGx_set.Oswietlenie", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Rezerwa24V_1",
           "GVL_Visu.stVisu_RGx_set.Rezerwa24V_1", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Rezerwa24V_2",
           "GVL_Visu.stVisu_RGx_set.Rezerwa24V_2", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Rezerwa24V_3",
           "GVL_Visu.stVisu_RGx_set.Rezerwa24V_3", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the RezerwaDC",
           "GVL_Visu.stVisu_RGx_set.RezerwaDC", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Supply_AGM_24V",
           "GVL_Visu.stVisu_RGx_set.Supply_AGM_24V", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Supply_LIION_24V",
           "GVL_Visu.stVisu_RGx_set.Supply_LIION_24V", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Supply_BUS_24V",
           "GVL_Visu.stVisu_RGx_set.Supply_BUS_24V", "bool", "N/A"},
          {"Change Circuit Breaker Switch Status on the Zasilanie760V_24V",
           "GVL_Visu.stVisu_RGx_set.Zasilanie760V_24V", "bool", "N/A"}
        ]
      },
      %{
        # EV
