  ...
  def get_containers do
    [
      ...
      %{
        ...
        items: [
          # Read
          {"P B Status on Inverter AFE Side", "GVL_Visu.stVisu_RGx_read.NSX250B_AFE", "", "N/A"},
          {"PB Status on Converter PV Side", "GVL_Visu.stVisu_RGx_read.NSX250B_PV", "", "N/A"},
          {"PB Status on Converter LIION Side", "GVL_Visu.stVisu_RGx_read.NSX250B_LIION", "",
           "N/A"},
          {"CB Status on the KontrolaDostepu", "GVL_Visu.stVisu_RGx_read.KontrolaDostepu", "",
           "N/A"},
          {"CB Status on the ObwodGniad1f", "GVL_Visu.stVisu_RGx_read.ObwodGniad1f", "", "N/A"},
          {"CB Status on the Wentylator1", "GVL_Visu.stVisu_RGx_read.Wentylator1", "", "N/A"},
          {"CB Status on the Wentylator2", "GVL_Visu.stVisu_RGx_read.Wentylator2", "", "N/A"},
          {"CB Status on the Wentylator3", "GVL_Visu.stVisu_RGx_read.Wentylator3", "", "N/A"},
          {"CB Status on the Wentylator4", "GVL_Visu.stVisu_RGx_read.Wentylator4", "", "N/A"},
          {"CB Status on the Klimatyzacja", "GVL_Visu.stVisu_RGx_read.Klimatyzacja", "", "N/A"},
          {"CB Status on the Rezerwa1_AC", "GVL_Visu.stVisu_RGx_read.Rezerwa1_AC", "", "N/A"},
          {"CB Status on the Rezerwa2_AC", "GVL_Visu.stVisu_RGx_read.Rezerwa2_AC", "", "N/A"},
          ...
          # Set
          {"Change CB Switch Status on the KontrolaDostepu",
           "GVL_Visu.stVisu_RGx_set.KontrolaDostepu", "bool", "N/A"},
          {"Change CB Switch Status on the ObwodGniad1f", "GVL_Visu.stVisu_RGx_set.ObwodGniad1f",
           "bool", "N/A"},
          {"Change CB Switch Status on the Wentylator1", "GVL_Visu.stVisu_RGx_set.Wentylator1",
           "bool", "N/A"},
          {"Change CB Switch Status on the Wentylator2", "GVL_Visu.stVisu_RGx_set.Wentylator2",
           "bool", "N/A"},
          {"Change CB Switch Status on the Wentylator3", "GVL_Visu.stVisu_RGx_set.Wentylator3",
           "bool", "N/A"},
          {"Change CB Switch Status on the Wentylator4", "GVL_Visu.stVisu_RGx_set.Wentylator4",
           "bool", "N/A"},
          {"Change CB Switch Status on the Klimatyzacja", "GVL_Visu.stVisu_RGx_set.Klimatyzacja",
           "bool", "N/A"},
          {"Change CB Switch Status on the Rezerwa1_AC", "GVL_Visu.stVisu_RGx_set.Rezerwa1_AC",
           "bool", "N/A"},
          {"Change CB Switch Status on the Rezerwa2_AC", "GVL_Visu.stVisu_RGx_set.Rezerwa2_AC",
           "bool", "N/A"},
      ...
      %{
        ...
        items: [
          # Read
          {"PB Status on Converter EV Side", "GVL_Visu.stVisu_RGx_read.NSX250B_EV", "", "N/A"},
          {"PB Status on Converter SCAP Side", "GVL_Visu.stVisu_RGx_read.NSX250B_SCAP", "",
           "N/A"},
          {"PB Status on Converter AGM Side", "GVL_Visu.stVisu_RGx_read.NSX250B_AGM", "", "N/A"},
          {"PB Status on Converter LOAD Side", "GVL_Visu.stVisu_RGx_read.NSX250B_LOAD", "",
           "N/A"},
          {"CB Status on the Rezerwa2_AC", "GVL_Visu.stVisu_RGx_read.ZasilaczeBMS1", "", "N/A"},
          {"CB Status on the Rezerwa2_AC", "GVL_Visu.stVisu_RGx_read.ZasilaczeBMS2", "", "N/A"},
          {"CB Status on the ZasilaczeBMS3", "GVL_Visu.stVisu_RGx_read.ZasilaczeBMS3", "", "N/A"},
          {"CB Status on the ZasilaczeBMS4", "GVL_Visu.stVisu_RGx_read.ZasilaczeBMS4", "", "N/A"},
          {"CB Status on the Oswietlenie", "GVL_Visu.stVisu_RGx_read.Oswietlenie", "", "N/A"},
          {"CB Status on the Rezerwa24V_1", "GVL_Visu.stVisu_RGx_read.Rezerwa24V_1", "", "N/A"},
          {"CB Status on the Rezerwa24V_2", "GVL_Visu.stVisu_RGx_read.Rezerwa24V_2", "", "N/A"},
          {"CB Status on the Rezerwa24V_3", "GVL_Visu.stVisu_RGx_read.Rezerwa24V_3", "", "N/A"},
          {"CB Status on the RezerwaDC", "GVL_Visu.stVisu_RGx_read.RezerwaDC", "", "N/A"},
          {"CB Status on the Supply_AGM_24V", "GVL_Visu.stVisu_RGx_read.Supply_AGM_24V", "",
           "N/A"},
          {"CB Status on the Supply_LIION_24V", "GVL_Visu.stVisu_RGx_read.Supply_LIION_24V", "",
           "N/A"},
          {"CB Status on the Supply_BUS_24V", "GVL_Visu.stVisu_RGx_read.Supply_BUS_24V", "",
           "N/A"},
          {"CB Status on the Zasilanie760V_24V", "GVL_Visu.stVisu_RGx_read.Zasilanie760V_24V", "",
           "N/A"},
          ...
          # Set
          {"Change CB Switch Status on the Rezerwa2_AC", "GVL_Visu.stVisu_RGx_set.ZasilaczeBMS1",
           "bool", "N/A"},
          {"Change CB Switch Status on the Rezerwa2_AC", "GVL_Visu.stVisu_RGx_set.ZasilaczeBMS2",
           "bool", "N/A"},
          {"Change CB Switch Status on the ZasilaczeBMS3",
           "GVL_Visu.stVisu_RGx_set.ZasilaczeBMS3", "bool", "N/A"},
          {"Change CB Switch Status on the ZasilaczeBMS4",
           "GVL_Visu.stVisu_RGx_set.ZasilaczeBMS4", "bool", "N/A"},
          {"Change CB Switch Status on the Oswietlenie", "GVL_Visu.stVisu_RGx_set.Oswietlenie",
           "bool", "N/A"},
          {"Change CB Switch Status on the Rezerwa24V_1", "GVL_Visu.stVisu_RGx_set.Rezerwa24V_1",
           "bool", "N/A"},
          {"Change CB Switch Status on the Rezerwa24V_2", "GVL_Visu.stVisu_RGx_set.Rezerwa24V_2",
           "bool", "N/A"},
          {"Change CB Switch Status on the Rezerwa24V_3", "GVL_Visu.stVisu_RGx_set.Rezerwa24V_3",
           "bool", "N/A"},
          {"Change CB Switch Status on the RezerwaDC", "GVL_Visu.stVisu_RGx_set.RezerwaDC",
           "bool", "N/A"},
          {"Change CB Switch Status on the Supply_AGM_24V",
           "GVL_Visu.stVisu_RGx_set.Supply_AGM_24V", "bool", "N/A"},
          {"Change CB Switch Status on the Supply_LIION_24V",
           "GVL_Visu.stVisu_RGx_set.Supply_LIION_24V", "bool", "N/A"},
          {"Change CB Switch Status on the Supply_BUS_24V",
           "GVL_Visu.stVisu_RGx_set.Supply_BUS_24V", "bool", "N/A"},
          {"Change CB Switch Status on the Zasilanie760V_24V",
